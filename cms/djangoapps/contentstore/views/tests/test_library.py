...
from student.roles import STUDIO_ADMIN_ACCESS_GROUP, LibraryUserRole
...
class UnitTestLibraries(CourseTestCase):
    ...
    def test_library_creator_status_with_no_course_creator_role_and_disabled_nonstaff_course_creation(self):
        ...
        nostaff_user.groups.add(GroupFactory(name=STUDIO_ADMIN_ACCESS_GROUP))
    ...
    def test_lib_create_permission(self):
        ...
        ns_user.groups.add(GroupFactory(name=STUDIO_ADMIN_ACCESS_GROUP))
