...
(function(globals) {
  ...
  var newcatalog = {
    ...
    " learners do not exist in LMS and not added to the exception list": "\u00e9tudiants n'existent pas dans le LMS et n'ont pas \u00e9t\u00e9 ajout\u00e9s \u00e0 la liste des exceptions", 
    ...
    "Enter 3-5 highlights to include in the email message that learners receive for this section (250 character limit).": "Saisissez 3-5 points cl\u00e9s \u00e0 inclure au courriel qui sera envoy\u00e9 aux \u00e9tudiants de cette section (minimum 250 caract\u00e8res).", 
    ...
    "Error resetting problem attempts for problem '<%= problem_id %>' and student '<%- student_id %>'. Make sure that the problem and student identifiers are complete and correct.": "Erreur lors la r\u00e9initialisation des essais pour l'exercoce '<%= problem_id %>' et l'\u00e9tudiant '<%= student_id %>'. V\u00e9rifiez qu'il n'y a pas d'erreur dans les identifiants du probl\u00e8me et de l'\u00e9tudiant. ", 
    ...
    "This feature is currently in testing. Course teams can enter highlights, but learners will not receive email messages.": "Cette fonction est actuellement en train d'\u00eatre contr\u00f4l\u00e9e. L'\u00e9quipe p\u00e9dagogique peut saisir les points cl\u00e9s, mais les \u00e9tudiants ne recevront pas de courriels.", 
