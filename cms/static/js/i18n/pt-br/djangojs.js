...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Error starting a task to rescore problem '<%- problem_id %>'. Make sure that the problem identifier is complete and correct.": "Erro ao come\u00e7ar a tarefa para reavaliar o problema '<%- problem_id %>'.Verifique se o identificador do problema est\u00e1 completo e correto.", 
    "Error starting a task to reset attempts for all learners on problem '<%- problem_id %>'. Make sure that the problem identifier is complete and correct.": "Erro ao iniciar uma tarefa para redefinir tentativas para todos os alunos com o problema '<%-problem_id %>'. Verifique se o identificador do problema est\u00e1 completo e correto.", 
    ...
    "Required": "Requerido", 
    "Required field.": "Campo obrigat\u00f3rio.", 
    "Rescore problem '<%- problem_id %>' for all learners?": "Reavaliar o problema '<%- problem_id %>' para todos os alunos", 
    "Reset My Password": "Redefinir minha senha", 
    "Reset Password": "Redefinir Senha", 
    "Reset Your Password": "Redefinir sua senha", 
    "Reset attempts for all learners on problem '<%- problem_id %>'?": "Redefinir tentativas para todos os alunos com problema '<%- problem_id %>'?", 
    ...
    "Successfully started task to rescore problem '<%- problem_id %>' for all learners. Click the 'Show Task Status' button to see the status of the task.": "Iniciado com sucesso a reavali\u00e7\u00e3o do problema '<%- problem_id %>' para todosos alunos. Clique no bot\u00e3o 'Mostrar Status da Tarefa' para ver o statusda tarefa.", 
    "Successfully started task to reset attempts for problem '<%- problem_id %>'. Click the 'Show Task Status' button to see the status of the task.": "Tarefa iniciada com sucesso para redefinir as tentativas do problema '<%- problem_id %>'. Clique em 'Mostrar status da tarefa' para ver o status.", 
