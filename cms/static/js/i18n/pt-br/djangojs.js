...
(function(globals) {
  ...
  var newcatalog = {
    ...
    "Course is not yet visible to students.": "Curso n\u00e3o est\u00e1 vis\u00edvel ainda para alunos.", 
    ...
    "Delete student '<%- student_id %>'s state on problem '<%- problem_id %>'?": "Excluir status do aluno '<%- student_id %>'s problema '<%- problem_id %>'?", 
    ...
    "Discussion admins, moderators, and TAs can make their posts visible to all students or specify a single group.": "Administradores de discuss\u00f5es, moderadores e TAs podem tornar suaspostagens vis\u00edveis para todos alunos ou para um \u00fanico grupo.", 
    ...
    "Error deleting student '<%- student_id %>'s state on problem '<%- problem_id %>'. Make sure that the problem and student identifiers are complete and correct.": "Erro ao excluir status do aluno '<%- student_id %>'s problema '<%- problem_id %>'. Verifique se o problema e os identificadores dos alunos est\u00e3o completos e corretos.", 
    ...
    "Error getting student progress url for '<%- student_id %>'. Make sure that the student identifier is spelled correctly.": "Erro ao obter o URL de progresso do aluno para '<%- student_id %>'. Certifique-se de que o identificador do aluno est\u00e1 escrito corretamente.", 
    ...
    "Error resetting problem attempts for problem '<%= problem_id %>' and student '<%- student_id %>'. Make sure that the problem and student identifiers are complete and correct.": "Erro ao redefinir as tentativas do problema '<%= problem_id %>' e aluno '<%- student_id %>'. Verifique se o problema e os identificadores de aluno est\u00e3o completos e corretos.", 
    ...
    "Error starting a task to override score for problem '<%- problem_id %>' for student '<%- student_id %>'. Make sure that the the score and the problem and student identifiers are complete and correct.": "Erro ao iniciar uma tarefa para classificar o problema. Verifique se apontua\u00e7\u00e3o, o problema e os identificadores est\u00e3o completos e corretos.", 
    "Error starting a task to rescore entrance exam for student '{student_id}'. Make sure that entrance exam has problems in it and student identifier is correct.": "Erro ao iniciar uma tarefa pra reavaliar o Exame de Admiss\u00e3o do aluno '{student_id}'. Tenha certeza de que o Exame de Admiss\u00e3o tenha quest\u00f5es nele e que o identificador do aluno esteja correto.", 
    "Error starting a task to rescore problem '<%- problem_id %>' for student '<%- student_id %>'. Make sure that the the problem and student identifiers are complete and correct.": "Erro ao iniciar uma tarefa para reavaliar o problema'<%- problem_id %>' para o aluno '<%- student_id %>'. Verifique se oproblema e os identificadores de alunos est\u00e3o completos e corretos.", 
    ...
    "Failed to delete student state for user.": "Falha ao excluir o estado do aluno para o usu\u00e1rio", 
    ...
    "Linking": "Vinculando", 
    "Links are generated on demand and expire within 5 minutes due to the sensitive nature of student information.": "Os links s\u00e3o gerados a pedido e expiram em 5 minutos devido\u00e0 natureza delicada das informa\u00e7\u00f5es do aluno.", 
    ...
    "Making Visible to Students": "Tornar vis\u00edvel para os alunos", 
    ...
    "Required": "Requerido", 
    "Required field.": "Campo obrigat\u00f3rio.", 
    "Rescore problem '<%- problem_id %>' for all students?": "Reavaliar o problema '<%- problem_id %>' para todos os alunos", 
    "Reset My Password": "Redefinir minha senha", 
    "Reset Password": "Redefinir Senha", 
    "Reset Your Password": "Redefinir sua senha", 
    "Reset attempts for all students on problem '<%- problem_id %>'?": "Redefinir tentativas para todos os alunos com problema '<%- problem_id %>'?", 
    ...
    "Started entrance exam rescore task for student '{student_id}'. Click the 'Show Task Status' button to see the status of the task.": "Tarefa de redefini\u00e7\u00e3o do exame de entrada iniciada para o aluno Clique nobot\u00e3o 'Mostrar Status da Tarefa' para ver o status da tarefa.", 
    "Started rescore problem task for problem '<%- problem_id %>' and student '<%- student_id %>'. Click the 'Show Task Status' button to see the status of the task.": "Tarefa de problema de rescore iniciada para o problema '<%- problem_id %>' and student ' <%- student_id %>'. Clique em 'Mostar status da tarefa' para ver o status.", 
    "Started task to override the score for problem '<%- problem_id %>' and student '<%- student_id %>'. Click the 'Show Task Status' button to see the status of the task.": "Tarefa iniciada para substituir a pontua\u00e7\u00e3o para o problema'<%- problem_id %>' e para o aluno. Clique no bot\u00e3o 'Mostrar Statusda Tarefa' para ver o status da tarefa.", 
    ...
    "Student": "Aluno", 
    "Student Removed from certificate white list successfully.": "Aluno removido com sucesso da lista branca de certificados.", 
    "Student email or username": "E-mail do aluno ou nome de usu\u00e1rio", 
    "Student username/email field is required and can not be empty. Kindly fill in username/email and then press \"Add to Exception List\" button.": "O campo nome de usu\u00e1rio/email \u00e9 obrigat\u00f3rio e n\u00e3o pode estar vazio. Por favor, preencha o nome de usu\u00e1rio /email e pressione o bot\u00e3o \"Adicionar \u00e0 lista de exce\u00e7\u00f5es\".", 
    "Student username/email field is required and can not be empty. Kindly fill in username/email and then press \"Invalidate Certificate\" button.": "O campo nome de usu\u00e1rio/email \u00e9 obrigat\u00f3rio e n\u00e3o pode estar vazio. Por favor, preencha o nome de usu\u00e1rio/email e pressione o bot\u00e3o \"Invalidar certificado\".", 
    ...
    "Success! Problem attempts reset for problem '<%- problem_id %>' and student '<%- student_id %>'.": "Sucesso! Tentativas de problema redefindas para '<%- problem_id %>' e aluno '<%- student_id %>'.", 
    ...
    "Successfully started task to rescore problem '<%- problem_id %>' for all students. Click the 'Show Task Status' button to see the status of the task.": "Iniciado com sucesso a reavali\u00e7\u00e3o do problema '<%- problem_id %>' para todosos alunos. Clique no bot\u00e3o 'Mostrar Status da Tarefa' para ver o statusda tarefa.", 
    ...
    "Titles more than 100 characters may prevent students from printing their certificate on a single page.": "T\u00edtulos com mais de 100 caracteres podem impedir que os estudantes imprimam seus certificados em uma \u00fanica p\u00e1gina.", 
    ...
    "You cannot view the course as a student or beta tester before the course release date.": "Voc\u00ea n\u00e3o pode ver o curso como aluno ou testador beta antes da data delan\u00e7amento do curso.", 
