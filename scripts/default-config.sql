insert into auth_group (name) values ('Studio Admin'), ('Catalog Denied Users'), ('EdFlex Denied Users'), ('Restricted Triboo Analytics Admin'), ('Triboo Analytics Admin'), ('Multi-Sites Login');
