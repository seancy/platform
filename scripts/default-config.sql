insert into auth_group (name) values ('Studio Admin'), ('Catalog Denied Users'), ('MyMooc Denied Users'), ('Restricted Triboo Analytics Admin'), ('Triboo Analytics Admin');
insert into waffle_switch (name, active, created, modified, note) values ('completion.enable_completion_tracking', 1, now(), now(), "");
insert into grades_persistentgradesenabledflag (enabled, enabled_for_all_courses, change_date) values (0, 1, now());
