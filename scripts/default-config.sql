insert into auth_group (name) values ('Studio Admin'), ('Catalog Denied Users'), ('EdFlex Denied Users'), ('Crehana Denied Users'), ('Anderspink Denied Users'), ('Restricted Triboo Analytics Admin'), ('Triboo Analytics Admin'), ('Multi-Sites Login');
