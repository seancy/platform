...
class PasswordCreateConfirmation extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      password: '',
...
PasswordCreateConfirmation.propTypes = {
  csrfToken: PropTypes.string.isRequired,
  errorMessage: PropTypes.string,
};

PasswordCreateConfirmation.defaultProps = {
  errorMessage: '',
};

export { PasswordCreateConfirmation }; // eslint-disable-line import/prefer-default-export
