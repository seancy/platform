...
(function(globals) {
  ...
  var newcatalog = {
    ...
    " learner is already white listed and not added to the exception list": "apprenant d\u00e9j\u00e0 ajout\u00e9 \u00e0 la liste blanche et non ajout\u00e9 \u00e0 la liste des exceptions", 
    " learner is not enrolled in course and not added to the exception list": "cet apprenant n'est pas inscrit au cours et n'est pas ajout\u00e9 \u00e0 la liste des exceptions", 
    " learner is successfully added to the exception list": "apprenant ajout\u00e9 avec succ\u00e8s \u00e0 la liste d'exception", 
    " learners are already white listed and not added to the exception list": "apprenants d\u00e9j\u00e0 ajout\u00e9s \u00e0 la liste blanche et non ajout\u00e9s \u00e0 la liste des exceptions", 
    " learners are not enrolled in course and not added to the exception list": "ces apprenants ne sont pas inscrits au cours et ne sont pas ajout\u00e9s \u00e0 la liste des exceptions", 
    " learners are successfully added to exception list": "apprenants ajout\u00e9s avec succ\u00e8s \u00e0 la liste d'exception", 
    " learners do not exist in LMS and not added to the exception list": "apprenants n'existent pas dans le LMS et n'ont pas \u00e9t\u00e9 ajout\u00e9s \u00e0 la liste des exceptions", 
    ...
    " records are not in correct format and not added to the exception list": "enregistrement ne sont pas dans le bon format et n'ont pas pas \u00e9t\u00e9 ajout\u00e9s \u00e0 la liste des exceptions", 
    "#Replies": "#R\u00e9ponses", 
    "${listPrice}": "${listPrice}", 
    ...
    "A list of courses you have just enrolled in as a verified learner": "Une liste de cours o\u00f9 vous venez de vous inscrire en tant qu'apprenant v\u00e9rifi\u00e9", 
    "A name that identifies your team (maximum 255 characters).": "Un nom qui d\u00e9signe votre \u00e9quipe (maximum 255 caract\u00e8res)", 
    "A short description of the team to help other learners understand the goals or direction of the team (maximum 300 characters).": "Une courte description de l'\u00e9quipe pour aider les autres apprenants \u00e0 comprendre les buts ou l'id\u00e9e directrice de l'\u00e9quipe (maximum 300 caract\u00e8res).", 
    ...
    "Access to some content in this unit is restricted to specific groups of learners": "L'acc\u00e8s \u00e0 une partie du contenu de cette unit\u00e9 est restreint \u00e0 un groupe d'apprenants sp\u00e9cifique.", 
    "Access to some content in this {blockType} is restricted to specific groups of learners.": "L'acc\u00e8s \u00e0 une partie du contenu de ce {blockType} est restreint \u00e0 un groupe d'apprenants sp\u00e9cifique.", 
    ...
    "Advanced": "Avanc\u00e9", 
    "After the course\\'s end date has passed, learners can no longer access subsection content. The subsection remains included in grade calculations.": "Une fois la date de fin du cours pass\u00e9e, les apprenants n'auront plus acc\u00e8s au contenu de la sous-section. La sous-section sera toujours prise en compte lors du calcul des notes.", 
    ...
    "All learners in the {track_name} track": "Tout apprenant dans le parcours de {track_name}", 
    ...
    "Allow learners to generate certificates for this course?": "Autoriser les apprenants \u00e0 g\u00e9n\u00e9rer des certificats pour ce cours?", 
    ...
    "An error occurred. Make sure that the learner's username or email address is correct and try again.": "Une erreur est survenue. Assurez-vous que l'identifiant et le courriel de l'apprenant sont corrects et essayez de nouveau.", 
    ...
    "Are you sure to unenroll this learner ?": "\u00cates-vous s\u00fbr(e) de vouloir d\u00e9sinscrire cet apprenant ?", 
    ...
    "Assign learners to cohorts by uploading a CSV file": "R\u00e9partissez les apprenants entre les cohortes en chargeant un fichier CSV", 
    ...
    "CSV file ready for upload": "Le fichier CSV est pr\u00eat \u00e0 \u00eatre charg\u00e9", 
    ...
    "Caption": "L\u00e9gende", 
    "Category": "Cat\u00e9gorie", 
    "Caution: The last published version of this unit is live. By publishing changes you will change the learner experience.": "Attention: la derni\u00e8re version publi\u00e9e de cette unit\u00e9 est active. En publiant des modifications vous allez changer l'exp\u00e9rience des apprenants.", 
    "Cell": "Cellule", 
    ...
    "Course is not yet visible to learners.": "Ce cours n'est pas encore visible pour les apprenants.", 
    ...
    "Delete learner '<%- student_id %>'s state on problem '<%- problem_id %>'?": "Supprimer l'\u00e9tat de l'apprenant '<%= student_id %>' sur le probl\u00e8me '<%= problem_id %>' ?", 
    ...
    "Discussion admins, moderators, and TAs can make their posts visible to all learners or specify a single group.": "Les administrateurs de discussions, mod\u00e9rateurs, et assistants peuvent rendre leur message visible pour tous les apprenants ou seulement un groupe sp\u00e9cifique.", 
    "Discussion topics in the course are not divided.": "Les sujets de discussions du cours ne sont pas s\u00e9par\u00e9s.", 
    "Discussions are unified; all learners interact with posts from other learners, regardless of the group they are in.": "Les discussions sont unies\u00a0; tous les apprenants interagissent avec les messages d'autres apprenants, peu importe le groupe auquel ils appartiennent.", 
    ...
    "Do you want to allow this learner ('{student_id}') to skip the entrance exam?": "Voulez-vous dispenser l'apprenant ('{student_id}') d'examen d'entr\u00e9e?", 
    ...
    "Enter 3-5 highlights to include in the email message that learners receive for this section (250 character limit).": "Saisissez 3-5 points cl\u00e9s \u00e0 inclure au courriel qui sera envoy\u00e9 aux apprenants de cette section (minimum 250 caract\u00e8res).", 
    "Enter Due Date and Time": "Entrez la date et heure d'\u00e9ch\u00e9ance", 
    "Enter Start Date and Time": "Entrez la date et heure de d\u00e9but", 
    "Enter a learner's username or email address.": "Entrez un nom d'utilisateur et un email.", 
    ...
    "Enter email addresses and/or usernames, separated by new lines or commas, for the learners you want to add. *": "Saisissez les adresses e-mail et/ou les noms d'utilisateurs, s\u00e9par\u00e9s par des retours \u00e0 la ligne ou des virgules, pour les apprenants que vous voulez ajouter. *", 
    ...
    "Entrance exam attempts is being reset for learner '{student_id}'.": "Le nombre d'examens d'entr\u00e9e est r\u00e9initialis\u00e9 pour l'apprenant '{student_id}'.", 
    "Entrance exam state is being deleted for learner '{student_id}'.": "Effacement du status de l'examen d'entr\u00e9e pour l'apprenant '{student_id}'.", 
    "Error": "Erreur", 
    ...
    "Error deleting entrance exam state for learner '{student_id}'. Make sure learner identifier is correct.": "Erreur de suppression du status d'examen d'entr\u00e9e pour l'apprenant '{student_id}'. Assurez-vous que l'identifiant apprenant est correct.", 
    "Error deleting learner '<%- student_id %>'s state on problem '<%- problem_id %>'. Make sure that the problem and learner identifiers are complete and correct.": "Erreur lors de la suppression de l'\u00e9tat de l'apprenant '<%- student_id %>' pour le probl\u00e8me '<%- problem_id %>' V\u00e9rifiez qu'il n'y a pas d'erreur dans les identifiants du probl\u00e8me et de l'apprenant. ", 
    ...
    "Error generating learner profile information. Please try again.": "Erreur lors de la cr\u00e9ation des informations du profil apprenant. Merci d\u2019essayer \u00e0 nouveau.", 
    "Error generating list of learners who may enroll. Please try again.": "Erreur lors de la g\u00e9n\u00e9ration de la liste des apprenants pouvant s'inscrire. Merci d'essayer de nouveau.", 
    ...
    "Error getting entrance exam task history for learner '{student_id}'. Make sure learner identifier is correct.": "Erreur d'obtention de l'historique d'examen d'entr\u00e9e pour l'apprenant '{student_id}'. Assurez-vous que l'identifiant apprenant est correct.", 
    "Error getting issued certificates list.": "Erreur lors de la r\u00e9cup\u00e9ration de la liste des certificats d\u00e9livr\u00e9s.", 
    "Error getting learner list.": "Erreur lors de la r\u00e9cup\u00e9ration de la liste des apprenants.", 
    "Error getting learner progress url for '<%- student_id %>'. Make sure that the learner identifier is spelled correctly.": "Erreur dans l'obtention de l'url de progression de l'apprenant '<%- student_id %>'. V\u00e9rifiez qu'il n'y a pas d'erreur dans l'identifiant de l'apprenant. ", 
    "Error getting task history for problem '<%- problem_id %>' and learner '<%- student_id %>'. Make sure that the problem and learner identifiers are complete and correct.": "Erreur dans la r\u00e9cup\u00e9ration de l'historique du probl\u00e8me '<%- problem_id %>' pour l'apprenant '<%- student_id %>'. V\u00e9rifiez qu'il n'y a pas d'erreur dans les identifiants du probl\u00e8me et de l'apprenant. ", 
    ...
    "Error listing task history for this learner and problem.": "Erreur lors de l'affichage de l'historique des t\u00e2ches pour cet apprenant et cet exercice.", 
    ...
    "Error resetting entrance exam attempts for learner '{student_id}'. Make sure learner identifier is correct.": "Erreur lors de la r\u00e9initialisation du nombre d'examens d'entr\u00e9e pour l'apprenant '{student_id}'. Assurez-vous que l'identifiant apprenant est correct.", 
    "Error resetting problem attempts for problem '<%= problem_id %>' and learner '<%- student_id %>'. Make sure that the problem and learner identifiers are complete and correct.": "Erreur lors la r\u00e9initialisation des essais pour l'exercoce '<%= problem_id %>' et l'apprenant '<%= student_id %>'. V\u00e9rifiez qu'il n'y a pas d'erreur dans les identifiants du probl\u00e8me et de l'apprenant. ", 
    ...
    "Error starting a task to override score for problem '<%- problem_id %>' for learner '<%- student_id %>'. Make sure that the the score and the problem and learner identifiers are complete and correct.": "Erreur dans le remplacement de la note du probl\u00e8me '<%- problem_id %>' de l'apprenant '<%- student_id %>'. V\u00e9rifiez qu'il n'y a pas d'erreur dans les identifiants du probl\u00e8me et de l'apprenant.", 
    "Error starting a task to rescore entrance exam for learner '{student_id}'. Make sure that entrance exam has problems in it and learner identifier is correct.": "Erreur dans le d\u00e9marrage de la t\u00e2che de recalcul du score de l'examen d'entr\u00e9e pour l'apprenant  '{student_id}'. Assurez-vous que l'examen d'entr\u00e9e comporte des exercices et que l'identifiant de l'apprenant est correct.", 
    "Error starting a task to rescore problem '<%- problem_id %>' for learner '<%- student_id %>'. Make sure that the the problem and learner identifiers are complete and correct.": "Erreur dans le recalcul du score du probl\u00e8me '<%- problem_id %>' pour l'apprenant '<%- student_id %>'. V\u00e9rifiez qu'il n'y a pas d'erreur dans les identifiants du probl\u00e8me et de l'apprenant. ", 
    "Error starting a task to rescore problem <code>'<%- problem_id %>'</code>. Make sure that the problem identifier is complete and correct.": "Erreur dans le recalcul des scores du probl\u00e8me <code>'<%- problem_id %>'</code>. V\u00e9rifiez que l'identifiant du probl\u00e8me est complet et correct. ", 
    "Error starting a task to reset attempts for all learners on problem <code>'<%- problem_id %>'</code>. Make sure that the problem identifier is complete and correct.": "Erreur dans la r\u00e9initialisation des essais de tous les apprenants pour le probl\u00e8me <code>'<%- problem_id %>'</code>. V\u00e9rifiez que l'identifiant du probl\u00e8me est complet et correct. ", 
    ...
    "Explicitly Hiding from Learners": "Cacher explicitement aux apprenants", 
    ...
    "Failed to delete learner state for user.": "Impossible de supprimer l'\u00e9tat de l'apprenant pour cet utilisateur.", 
    ...
    "Find answers to the top questions asked by learners.": "Trouver les r\u00e9ponses aux principales questions pos\u00e9es par vos apprenants.", 
    ...
    "Hiding from Learners": "Cacher aux apprenants", 
    ...
    "How to use discussions": "Comment utiliser les discussions", 
    "Hyperlink (Ctrl+L)": "Hyperlien (Ctrl+L)", 
    "I want to delete the course": "Je souhaite supprimer le cours", 
    "ID": "ID", 
    ...
    "If the course does not have an end date, learners always see their scores when they submit answers to assessments.": "Si le cours ne comporte aucune date de fin du cours, les apprenants pourront toujours voir leurs notes apr\u00e8s avoir donn\u00e9 leurs r\u00e9ponses lors de l'\u00e9valuation. ", 
    "If the subsection does not have a due date, learners always see their scores when they submit answers to assessments.": "Si la sous-section n'a aucune date d'\u00e9ch\u00e9ance, les apprenants pourront toujours voir leurs notes apr\u00e8s avoir donn\u00e9 leurs r\u00e9ponses lors de l'\u00e9valuation. ", 
    ...
    "If the unit was previously published and released to learners, any changes you made to the unit when it was hidden will now be visible to learners. Do you want to proceed?": "Si l'unit\u00e9 a d\u00e9j\u00e0 \u00e9t\u00e9 publi\u00e9e et diffus\u00e9e aux apprenants, tous les changements apport\u00e9s \u00e0 l'unit\u00e9 pendant qu' elle \u00e9tait cach\u00e9e seront d\u00e9sormais visibles par les apprenants. Voulez-vous continuer?", 
    "If you are unable to access your account contact us via email using {email}.": "Si vous ne pouvez acc\u00e9der \u00e0 votre compte, contactez le support \u00e0 cette adresse {email}.", 
    ...
    "If you proceed, you will be unable to use this account to take courses on the ": "Si vous continuez, vous ne serez plus capable d'utiliser ce compte pour ", 
    ...
    "Inheriting Learner Visibility": "H\u00e9riter la visibilit\u00e9 pour les apprenants", 
    "Inline": "Int\u00e9gr\u00e9", 
    "Insert": "Ins\u00e9rer", 
    ...
    "Last updated": "Derni\u00e8re mise \u00e0 jour", 
    "Learn More": "En lire plus.", 
    "Learn more about {license_name}": "En savoir plus sur {license_name}", 
    "Learner": "Apprenant", 
    "Learner Removed from certificate white list successfully.": "Apprenant retir\u00e9 avec succ\u00e8s de la liste blanche des certificats.", 
    "Learner email or username": "Nom d'utilisateur ou email", 
    "Learner username/email field is required and can not be empty. Kindly fill in username/email and then press \"Add to Exception List\" button.": "Le champ apprenant utilisateur/courriel est n\u00e9cessaire et ne peut \u00eatre vide. Veuillez remplir utilisateur/courriel et ensuite appuyer le bouton \"Ajouter \u00e0 la liste de D\u00e9rogation\".", 
    "Learner username/email field is required and can not be empty. Kindly fill in username/email and then press \"Invalidate Certificate\" button.": "Le champ nom d'utilisateur / email de l'apprenant est requis et ne peut \u00eatre vide. Merci de saisir le nom d'utilisateur / email et appuyer sur le bouton \"Invalidate Certificate\".", 
    ...
    "Learners never see whether their answers to assessments are correct or incorrect, nor the score received.": "Les apprenants ne voient jamais si leurs r\u00e9ponses aux \u00e9valuations sont justes ou fausses, et ne re\u00e7oivent jamais la note.", 
    ...
    "Linking": "Lier", 
    "Links are generated on demand and expire within 5 minutes due to the sensitive nature of learner information.": "Les liens sont g\u00e9n\u00e9r\u00e9s sur demande et expirent dans les 5 minutes \u00e0 cause de la nature sensible des informations concernant l'apprenant.", 
    ...
    "Login in SSO": "Se connecter via SSO", 
    "Loud": "Fort", 
    "Low": "Faible", 
    ...
    "MB": "MB", 
    "Make Visible to Learners": "Rendre visible aux apprenants", 
    ...
    "Making Visible to Learners": "Rendre visible pour les apprenants", 
    ...
    "Name of the groups that learners will be assigned to, for example, Control, Video, Problems. You must have two or more groups.": "Nom des groupes auxquels les apprenants seront affect\u00e9s, par exemple, contr\u00f4le, vid\u00e9o, probl\u00e8mes. Vous devez avoir deux groupes ou plus.", 
    ...
    "Number of Learners": "Nombre d'apprenants", 
    ...
    "Once your account is deleted, you cannot use it to take courses on {platformName}.": "Une fois votre compte supprim\u00e9, vous ne pourrez plus vous inscrire \u00e0 un cours sur {platformName}.", 
    ...
    "Password Reset Email Sent": "Mail de r\u00e9initialisation du mot de passe envoy\u00e9", 
    ...
    "Please choose the accommodation need": "Veuillez choisir la demande de r\u00e9servation d\u2019h\u00f4tel", 
    ...
    "Please enter a learner email address or username.": "Merci d\u2019entrer le nom d\u2019utilisateur ou l\u2019adresse e-mail d\u2019un apprenant.", 
    ...
    "Please note: Deletion of your account and personal data is permanent and cannot be undone. We will not be able to recover your account or the data that is deleted.": "Attention : La suppression de votre compte et des donn\u00e9es personnelles est irr\u00e9versible. Votre compte ou les donn\u00e9es supprim\u00e9es ne pourront pas \u00eatre r\u00e9cup\u00e9r\u00e9es.", 
    ...
    "Prevent learners from generating certificates in this course?": "Emp\u00eacher les apprenants de g\u00e9n\u00e9rer des certificats pour ce cours?", 
    "Preview": "Aper\u00e7u", 
    ...
    "Registered users now enrolled in this course:": "Apprenants actuellement inscrits \u00e0 ce cours :", 
    "Registered users who were already enrolled (no changes):": "Apprenants \u00e9tant d\u00e9j\u00e0 inscrits au cours (pas de changement):", 
    ...
    "Required": "Requis", 
    "Required field.": "Champ requis.", 
    "Rescore problem <code>'<%- problem_id %>'</code> for all learners?": "Recalculer le score du probl\u00e8me <code>'<%- problem_id %>'</code> pour tous les apprenants ?", 
    "Reset My Password": "R\u00e9initialiser mon mot de passe", 
    "Reset Password": "R\u00e9initialiser le mot de passe", 
    "Reset Your Password": "R\u00e9initialiser votre mot de passe", 
    "Reset attempts for all learners on problem <code>'<%- problem_id %>'</code>?": "R\u00e9initialiser les essais de tous les apprenants pour l'exercice <code>'<%= problem_id %>'</code>?", 
    "Reset my password": "R\u00e9initialiser mon mot de passe", 
    ...
    "Search the {platform} Help Center": "Rechercher dans le centre d'aide", 
    "Section": "Section", 
    ...
    "Select a prerequisite subsection and enter a minimum score percentage and minimum completion percentage to limit access to this subsection. Allowed values are 0-100": "S\u00e9lectionnez une sous-section pr\u00e9-requise et saisissez une note minimum en pourcentage et un pourcentage de r\u00e9ussite minimum afin de limiter l'acc\u00e8s \u00e0 cette sous-section. Les valeurs doivent \u00eatre comprises entre 0 et 100.", 
    ...
    "Some text would be here?": "Texte \u00e0 customiser", 
    ...
    "Specify any rules or rule exceptions that the proctoring review team should enforce when reviewing the videos. For example, you could specify that calculators are allowed. These specified rules are visible to learners before the learners start the exam.": "Veuillez indiquer toute r\u00e8gle ou exception \u00e0 la r\u00e8gle que l'\u00e9quipe de r\u00e9vision d'examens surveill\u00e9s doit imposer lors de la r\u00e9vision des vid\u00e9os. Par exemple, vous pourriez indiquer que les calculatrices sont permises. Ces r\u00e8gles pr\u00e9cis\u00e9es sont visibles aux apprenants avant  que les apprenants ne commencent l'examen.", 
    ...
    "Start generating certificates for all learners in this course?": "D\u00e9marrer la g\u00e9n\u00e9ration des certificats pour tous les apprenants du cours?", 
    "Start of transcript. Skip to the end.": "D\u00e9but de la transcription. Avancer jusqu'\u00e0 la fin.", 
    "Start regenerating certificates for learners in this course?": "D\u00e9marrer la r\u00e9g\u00e9n\u00e9ration des certificats pour tous les apprenants du cours?", 
    ...
    "Started entrance exam rescore task for learner '{student_id}'. Click the 'Show Task Status' button to see the status of the task.": "Le recalcul du score de l'examen d'entr\u00e9e de l'apprenant'{student_id}' a commenc\u00e9. Cliquez sur le bouton \u00abAfficher l\u2019\u00e9tat des t\u00e2ches\u00bb pour voir l'\u00e9tat de la t\u00e2che.", 
    "Started rescore problem task for problem '<%- problem_id %>' and learner '<%- student_id %>'. Click the 'Show Task Status' button to see the status of the task.": "Le recalcul du score de l'exercice '<%- problem_id %>' de l'apprenant '<%- student_id %>' a commenc\u00e9. Cliquez sur le bouton \u00abAfficher l\u2019\u00e9tat des t\u00e2ches\u00bb pour voir l'\u00e9tat de la t\u00e2che.", 
    "Started task to override the score for problem '<%- problem_id %>' and learner '<%- student_id %>'. Click the 'Show Task Status' button to see the status of the task.": "La t\u00e2che de remplacement de la note pour le probl\u00e8me '<%- problem_id %>' de l'apprenant '<%- student_id %>' a commenc\u00e9. Cliquez sur le bouton \u00abAfficher l\u2019\u00e9tat des t\u00e2ches\u00bb pour voir l'\u00e9tat de la t\u00e2che.", 
    ...
    "Success! Problem attempts reset for problem '<%- problem_id %>' and learner '<%- student_id %>'.": "Nombre d'essai r\u00e9initialis\u00e9 pour l'exercice  '<%= problem_id %>' de l'apprenant '<%= student_id %>'.", 
    "Successfully deleted learner state for user {user}": "Suppression r\u00e9ussie de l'\u00e9tat de l'apprenant pour l'utilisateur {user}", 
    ...
    "Successfully rescored problem to improve score for user {user}": "R\u00e9\u00e9valuation r\u00e9ussie du probl\u00e8me pour l'utilisateur {user}, \u00e0 son avantage", 
    ...
    "Successfully sent welcoming emails to the following addresses:": "Emails de bienvenue correctement envoy\u00e9s aux adresses suivantes :", 
    "Successfully started task to rescore problem <code>'<%- problem_id %>'</code> for all learners. Click the 'Show Task Status' button to see the status of the task.": "D\u00e9marrage de la t\u00e2che consistant \u00e0 recalculer la note du probl\u00e8me<code>'<%- problem_id %>'</code> pour tous les apprenants effectu\u00e9 avec succ\u00e8s. Cliquez sur le bouton \u00abAfficher l\u2019\u00e9tat des t\u00e2ches\u00bb pour voir l'\u00e9tat de la t\u00e2che.", 
    "Successfully started task to reset attempts for problem <code>'<%- problem_id %>'</code>. Click the 'Show Task Status' button to see the status of the task.": "La t\u00e2che de r\u00e9initialisation de tentatives pour le probl\u00e8me <code>'<%- problem_id %>'</code> a d\u00e9marr\u00e9 avec succ\u00e8s. Cliquez sur le bouton \u00ab\u00a0Afficher l\u2019\u00e9tat des t\u00e2ches\u00a0\u00bb pour voir l'\u00e9tat de la t\u00e2che.", 
    ...
    "The enrollment is confirmed.<br>You can change information related to the demand by clicking on the << Upcoming Sessions >> tab.": "L'inscription est confirm\u00e9e.<br>Vous pouvez changer les information relatives \u00e0 la demande dans l'onglet \"Sessions \u00e0 venir\".", 
    ...
    "The following email addresses are invalid:": "Les adresses e-mail suivantes sont invalides :", 
    ...
    "The general category for this type of assignment, for example, Homework or Midterm Exam. This name is visible to learners.": "La cat\u00e9gorie g\u00e9n\u00e9rale pour ce type de devoir, par exemple, devoirs maisons ou examen de moiti\u00e9 d'ann\u00e9e. Ce nom est visible aux apprenants.", 
    ...
    "The threshold of all assignments of this type, by default it is 100. Do not include the percent symbol.": "Le seuil d'obtention du badge pour le quiz, par default 100. Ne pasinclure le symbole pourcentage", 
    ...
    "The {cohortGroupName} cohort has been created. You can manually add learners to this cohort below.": "La cohorte {cohortGroupName} a \u00e9t\u00e9 cr\u00e9e. Vous pouvez y ajouter manuellement des apprenants ci-dessous.", 
    ...
    "There must be one cohort to which learners can automatically be assigned.": "Au moins une cohorte doit \u00eatre cr\u00e9\u00e9e pour ajouter les apprenants en automatique.", 
    ...
    "There was an error in setting your goal, please reload the page and try again.": "Nous rencontrons une erreur dans le param\u00e9trage de vos objectifs.Rafraichissez la page pour r\u00e9essayer.", 
    ...
    "These users will be allowed to enroll once they register:": "Ces apprenants seront autoris\u00e9s \u00e0 s'inscrire une fois qu'il se seront enregistr\u00e9s  sur la plateforme :", 
    ...
    "This feature is currently in testing. Course teams can enter highlights, but learners will not receive email messages.": "Cette fonction est actuellement en train d'\u00eatre contr\u00f4l\u00e9e. L'\u00e9quipe p\u00e9dagogique peut saisir les points cl\u00e9s, mais les apprenants ne recevront pas de courriels.", 
    ...
    "This session is full": "Cette session est pleine", 
    "This session is no longer open to registration. Please choose another session.": "Les inscriptions \u00e0 cette session sont maintenant cl\u00f4tur\u00e9es. Veuillez choisir une autre session.", 
    ...
    "Titles more than 100 characters may prevent learners from printing their certificate on a single page.": "Les titres de plus de 100 caract\u00e8res peuvent emp\u00eacher les apprenants d'imprimer leur certificat sur une seule page.", 
    "To access the course, select a session.": "Pour acc\u00e9der \u00e0 ce cours, veuillez s\u00e9lectionner une session.", 
    "To be sure all learners can access the video, we recommend providing both an .mp4 and a .webm version of your video. Click below to add a URL for another version. These URLs cannot be YouTube URLs. The first listed video that's compatible with the learner's computer will play.": "Afin que tous les apprenants puisse acc\u00e9der \u00e0 la vid\u00e9o, nous vous recommandons de fournir une version .mp4 ainsi qu'une version .webm de la vid\u00e9o. Cliquer ci-dessous pour ajouter une URL pour une autre version. Les URLs youtube ne sont pas support\u00e9es. La premi\u00e8re vid\u00e9o de la liste compatible avec l'ordinateur de l'apprenant sera vue.", 
    ...
    "Upload File and Assign Learners": "Charger le fichier et associer les apprenants", 
    ...
    "User accounts successfully updated:": "Comptes apprenants mis \u00e0 jour avec succ\u00e9s:", 
    ...
    "Users successfully created and enrolled:": "Les apprenants suivants ont \u00e9t\u00e9 cr\u00e9\u00e9s et inscrits", 
    ...
    "Visible only to %(group_name)s": "Ce message est visible seulement par %(group_name)s.", 
    "Visible to": "Visible par", 
    "Visible to Staff Only": "Visible par l'\u00e9quipe p\u00e9dagogique seulement", 
    "Visible to everyone": "Ce message est visible par tous.", 
    ...
    "We've sent instructions to the email address you provided.": "Nous avons envoy\u00e9 les instructions \u00e0 l'email indiqu\u00e9", 
    "Web:": "Web :", 
    "Webcam": "Webcam", 
    ...
    "When learners submit an answer to an assessment, they immediately see whether the answer is correct or incorrect, and the score received.": "Lorsque les apprenants soumettent une r\u00e9ponse \u00e0 une \u00e9valuation, ils voient imm\u00e9diatement si la r\u00e9ponse est juste ou fausse, et la note est donn\u00e9e.", 
    ...
    "You are going to delete this course. All related data including learner data will be permanently deleted and this cannot be undone. We advise you to <a href=\"%(exportUrl)s\" target=\"_blank\" class=\"link-export\">export the course content</a> before you delete it.": "Vous \u00eates sur le point de supprimer ce cours. Toutes les donn\u00e9es qui lui sont li\u00e9es, y compris les donn\u00e9es apprenants, seront supprim\u00e9es de mani\u00e8re permanente et cette action ne pourra \u00eatre annul\u00e9e. Nous vous sugg\u00e9rons d'<a href=\"%(exportUrl)s\" target=\"_blank\" class=\"link-export\">exporter le contenu du cours</a> avant de le supprimer.", 
    ...
    "You are now enrolled as a verified learner for:": "Vous vous \u00eates maintenant engag\u00e9 en tant qu'apprenant v\u00e9rifi\u00e9 pour :", 
    ...
    "You can upload an image that you want to associate with your username. Your image must be a .gif, .jpg or .png file. We recommend to use the format 200x200 pixels. The size of the image must be below 1Mb.": "Vous pouvez charger une image associ\u00e9e \u00e0 votre profil. Votre image doit \u00eatre au format .gif .jpg or .png. Nous recommandons d'utiliser une taille de 200x200 pixels. La taille maximale ne doit pas d\u00e9passer 1Mb.", 
    ...
    "You cannot view the course as a learner or beta tester before the course release date.": "Vous ne pouvez pas voir le cours en tant qu'apprenant ou en tant que b\u00eata testeur avant la date de publication du cours.", 
    ...
    "You have selected \u201cDelete my account.\u201d Deletion of your account and personal data is permanent and cannot be undone. ": "Vous avez s\u00e9lectionn\u00e9 \u00ab Supprimer mon compte \u00bb. La suppression d'un compte et des donn\u00e9es personnelles est permanente et ne peut \u00eatre annul\u00e9e.", 
    ...
    "You may also lose access to verified certificates. If you want to make a copy of these for your records before proceeding with deletion, follow the instructions for {htmlStart}printing or downloading a certificate{htmlEnd}.": "Vous pouvez \u00e9galement perdre l'acc\u00e8s aux certificats v\u00e9rifi\u00e9s. Si vous souhaitez en faire une copie pour vos archives avant de poursuivre la suppression, veuillez suivre les instructions pour {htmlStart}imprimer ou t\u00e9l\u00e9charger un certificat{htmlEnd}.", 
    ...
    "day(s) after enrollment": "jour(s) apr\u00e8s inscription", 
    ...
    "provide the title/name of the text book as you would like your learners to see it": "veuillez fournir le titre/nom du manuel comme vous souhaiteriez que vos apprenants le voient.", 
    "remove": "supprimer", 
